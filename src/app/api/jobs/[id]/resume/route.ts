...
// Future: import { generateTailoredResume } from "@/lib/llm/gemini";
...
export async function POST(
  ...
  // Future feature — resume generation via Gemini API.
  // Uncomment the block below and set GEMINI_API_KEY to enable.
  return NextResponse.json(
    { error: "Resume generation is not enabled yet (coming soon)" },
    { status: 501 }
  );
